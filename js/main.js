...
function initSearch() {
    ...
    if (searchInput) {
        searchInput.addEventListener('input', (e) => {
            ...
            // Sample search data
            const articles = [
                { title: '四个女仔自由行', tag: '匈牙利&奥地利&捷克' },
                { title: '冰岛的极光与冰川', tag: '冰岛' },
                { title: '罗马的历史与浪漫', tag: '意大利 · 罗马' },
                { title: '巴塞罗那的艺术之旅', tag: '西班牙 · 巴塞罗那' },
                { title: '特罗姆瑟的北极体验', tag: '挪威 · 特罗姆瑟' },
                { title: '米兰的时尚与艺术', tag: '意大利 · 米兰' }
            ];

            const destinations = [
                '维也纳', '布达佩斯', '布拉格', '米兰', '罗马', '冰岛', '特罗姆瑟', '西班牙', '纽约', '巴黎', '北海道'
            ];
